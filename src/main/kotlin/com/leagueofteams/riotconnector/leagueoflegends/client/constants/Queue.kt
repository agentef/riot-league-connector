...
enum class Queue(val id: Int, val map: String, val description: String?, val notes: String?) {
    ...
    SR_COOP_BEGINNER_OLD        (32,        "Summoner's Rift",      "Co-op vs AI Beginner Bot games", "Deprecated in patch 7.19 in favor of queueId 840"),
    ...
    fun findById(id: Int): Queue {
        return values().toList().stream().filter {it.id == id}.findFirst().orElseThrow {
            throw RiotException(HttpStatus.BAD_REQUEST, "Invalid Queue Id was provided. If you believe this was a mistake, please try and update your dependency.")
        }
    }
} 